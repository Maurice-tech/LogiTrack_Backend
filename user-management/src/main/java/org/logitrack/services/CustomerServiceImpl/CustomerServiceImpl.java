...
//    @Value("${exchange-name}")
    private String exchangeName = "logitrack-exchange";

//    @Value("${user-registration-routing-key}")
    private String userRegistrationRoutingKey = "user-registration";

//    @Value("${delivery-man-creation-routing-key}")
    private String deliveryManCreationRoutingKey = "delivery-man-creation";
    ...
    public ApiResponse registerUser(AppUserRegistrationRequest registrationDTO) {
        ...
        log.info("verification token generated..." + confirmationToken.getConfirmationToken());
    ...
    public ApiResponse registerDeliveryMan(DeliveryManCreationRequest request, String email) {
        ...
        MessagingObject msg = MessagingObject.builder()
                .message(message)
                .subject("Rider Account Created")
                .senderName("LOGI-TRACK TEAM")
